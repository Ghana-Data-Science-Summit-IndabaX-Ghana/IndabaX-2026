...
class TestSymptomChecker:
    ...
    def test_malaria_primary_symptoms(self):
        ...
        from tools.symptom_checker_soln import check_symptoms
...
class TestFacilityLocator:
    ...
    def test_find_level_1_facility(self):
        ...
        from tools.facility_locator_soln import find_facility
...
class TestEscalationTrigger:
    ...
    def test_snakebite_always_escalates(self):
        ...
        from tools.escalation_trigger_soln import evaluate_escalation
...
class TestAgentLoop:
    ...
    def setup(self):
        from agent.core_soln import AmaAgent
